<?php
    ...
    if(isset($_GET['delete']))
    {
          ...
          $adn="DELETE FROM  iBookStore_book_categories  WHERE  cat_id = ?";
         ...
         if($stmt)
         {
             $success = "Deleted" && header("refresh:1; url=pages_admin_manage_category.php");
         }
         else
         {
             $err = "Try Again Later";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <a class="text-warning dropdown-item" href="pages_admin_update_category.php?update=<?php echo $categories->cat_id;?> ">Update Category</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="text-danger dropdown-item" href="pages_admin_manage_category.php?delete=<?php echo $categories->cat_id;?>">Delete Category</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
