        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="dashboard" data-parent="#accordionExample">
                    <li class="active">
                        <a href="pages_admin_dashboard.php"> Sales </a>
                    </li>
                    <li>
                        <a href="pages_admin_analytics.php"> Analytics </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="books" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="pages_admin_add_book.php"> Add Book </a>
                    </li>                            
                    <li>
                        <a href="pages_admin_manage_books.php"> Manage Books </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="sales" data-parent="#accordionExample">
                    <li>
                        <a href="pages_admin_add_sale_record.php"> Add Record </a>
                    </li>
                    <li>
                        <a href="pages_admin_manage_sales_record.php"> Manage Sales </a>
                    </li>
                </ul>
            </li>

            <li class="menu">
                <a href="pages_admin_accounting.php" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu">
                <a href="pages_admin_inventory.php" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu">
                <a href="#ar" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled" id="ar" data-parent="#accordionExample">
                    <li>
                        <a href="pages_admin_reporting_staffs.php"> My Staff </a>
                    </li>
                    <li>
                        <a href="pages_admin_reporting_book_categories.php"> Book Categories </a>
                    </li>
                    <li>
                        <a href="pages_admin_reporting_books.php"> Books </a>
                    </li>
                    <li>
                        <a href="pages_admin_reporting_sales.php"> Sales </a>
                    </li>
                </ul>
            </li>
            <li class="menu">
                <a href="pages_admin_password_resets.php" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="System" data-parent="#accordionExample">
                    <li>
                        <a href="pages_admin_setting_front_end.php"> Front End </a>
                    </li>
                    <li>
                        <a href="pages_admin_db_backup.php"> Database Backups </a>
                    </li>
                </ul>
            </li>
        </ul>
