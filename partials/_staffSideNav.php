        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="dashboard" data-parent="#accordionExample">
                    <li class="active">
                        <a href="pages_staff_dashboard.php"> Dashboard </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="books" data-parent="#accordionExample">
                    <li>
                        <a href="pages_staff_add_book_category.php"> Add Category </a>
                    </li>
                    <li>
                        <a href="pages_staff_manage_category.php"> Manage Category  </a>
                    </li>
                    <li>
                        <a href="pages_staff_add_book.php"> Add Book </a>
                    </li>                            
                    <li>
                        <a href="pages_staff_manage_books.php"> Manage Books </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="sales" data-parent="#accordionExample">
                    <li>
                        <a href="pages_staff_add_sale_record.php"> Add Record </a>
                    </li>
                </ul>
            </li>
